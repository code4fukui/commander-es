import { EventEmitter } from './nodelike/events.js'; // node.js
import childProcess from './nodelike/child_process.js';
import path from './nodelike/path.js';
//const fs from 'fs';
import process from './nodelike/process.js';
